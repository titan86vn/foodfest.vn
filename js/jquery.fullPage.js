    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            if(typeof element.attr('class') === 'undefined'){ return; } //there's no element to scroll, leaving the function
        ...
        function landscapeScroll(slides, destiny){
            ...
            /*if(options.css3){
			 ...
			 if (options.css3) {
                ...
                setTimeout(function() {
                    destiny.addClass(ACTIVE).siblings().removeClass(ACTIVE);
                    destiny.siblings().removeClass('is-leaving');
                    slides.find(SLIDES_CONTAINER_SEL).css(getTransforms(translate3d));
                }, 800);
                setTimeout(function() {
                    afterSlideLoads();
                }, options.scrollingSpeed, options.easing);
